...
def create_temporal_agent(tempdir, template_path, model_path, softmax_scale):
...
def get_sample_func_for_playing_against_top_n(agent_filepath, play_against_top_n, n_learning_agents):
    """ Creates a function for sampling agentes for playing against top n agents """
